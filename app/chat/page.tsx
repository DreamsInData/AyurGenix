...
export default function ChatPage() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: 'clamp(12px, 3vw, 24px)', height: 'calc(100vh - 64px)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div>
                        <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: 'clamp(1rem, 3vw, 1.3rem)' }}>AI Ayurvedic Chat</h1>
            ...
            <div style={{
                ...
                {messages.map((msg, i) => (
                    <div key={i} style={{
                        ...
                        <div style={{
                            maxWidth: 'min(85%, 600px)', padding: 'clamp(10px, 2vw, 14px) clamp(12px, 2vw, 18px)', borderRadius: '16px',
                            background: msg.role === 'user'
